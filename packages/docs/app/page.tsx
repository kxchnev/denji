  ...
  return (
    <article className="max-w-3xl">
      ...
      <p className="mt-3 text-lg text-muted-foreground">
        Free-form architecture diagrams (not C4) with controllable, relative layout — a mermaid
        alternative where you actually decide where things go.
      </p>
      <p className="mt-6 leading-7">
        Describe a diagram in the <code className="rounded bg-muted px-1.5 py-0.5 text-sm">.pwr</code>{" "}
        text DSL or with the programmatic builder — both produce the same model. Placement is{" "}
        <strong>relative</strong>: you anchor nodes to each other with hints like{" "}
        <code className="rounded bg-muted px-1.5 py-0.5 text-sm">@below</code> and{" "}
        <code className="rounded bg-muted px-1.5 py-0.5 text-sm">@rightOf</code>, and container blocks
        size themselves to wrap their contents.
      </p>
